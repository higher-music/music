...
export const COM_LEFT_MENU_STATUS = 'COM_LEFT_MENU_STATUS'
...
export const COM_PAGE_INIT_DATA = 'COM_PAGE_INIT_DATA'       //页面分页信息
export const COM_TIMMER = 'COM_TIMMER'                       //定时器
...
export const GET_MENUS_BY_USER = 'GET_MENUS_BY_USER' //获取菜单信息
export const SET_USER_MENU = 'SET_USER_MENU'  //设置菜单
